  ...
  const handleAuditWithAI = async () => {
    ...
    try {
      const res = await authorizedApiFetch('/api/chargpt', {
        ...
        body: JSON.stringify({
          prompt: `You are ${AI_NAME}, an evidence-aware BBQ planning assistant. Review my planned smoking schedule without claiming that planned or estimated values were observed:
